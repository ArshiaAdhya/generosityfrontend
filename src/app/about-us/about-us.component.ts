...
<button><p>1. Compassion: <br>We approach our work with empathy and understanding, recognizing the unique challenges individuals and communities face.</p></button>

<button><p>2. Transparency: <br>We believe in openness and accountability, ensuring that every donation is utilized effectively and ethically.</p></button>

<button><p>3. Collaboration: <br>Change happens when people come together. We actively seek partnerships and collaborations to amplify our impact.</p></button>

<button><p>4. Innovation: <br>We embrace new ideas and technologies to continually improve our platform and create a seamless giving experience.</p></button>
</div>
</div>
<br>
